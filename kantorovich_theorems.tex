...
\begin{thm}[Optimal Weights]
  ...
  \end{equation}
\end{thm}
Theorem 2 of \citeasnoun{Dupacova2003} is similar, whith the difference that there, $\chi(J)\subset \zeta(I)$.
...
\begin{algorithm}
  ...
  \KwOut{Optimal weights $q_j$ for the scenarios $j\in J$ and $D_K(\bs\zeta,\bs\chi)$}
